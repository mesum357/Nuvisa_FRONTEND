...
const BookingAppointment = ({
  ...
  const handleSave = () => {
    ...
    if (
      !appointmentData.preference1.dateRangeStart ||
      !appointmentData.preference1.dateRangeEnd
    ) {
      newErrors.preference1.dateRange =
        "Please select a date range for Preference 1";
      hasError = true;
    }
    ...
    if (p2HasAny) {
      ...
      if (
        (p2.dateRangeStart && !p2.dateRangeEnd) ||
        (!p2.dateRangeStart && p2.dateRangeEnd)
      ) {
        newP2Errors.dateRange =
          "Please complete the date range for Preference 2";
        p2Error = true;
      }
    ...
    const formatted = {
      preference1: {
        ...
        dateRange: `${formatDate(
          appointmentData.preference1.dateRangeStart
        )} - ${formatDate(appointmentData.preference1.dateRangeEnd)}`,
      ...
      <div className="bg-[#23232B] border border-[#423577] rounded-lg p-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-gray-700">
            Please give us a few options for your appointment. We may reach out
            to you for alternate slots, in case, we are unable to book this slot
            for you.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <DatePicker
                ...
                onChange={(dates) =>
                  handleDateRangeChange("preference1", dates)
                }
                minDate={new Date()}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <DatePicker
                ...
                onChange={(dates) =>
                  handleDateRangeChange("preference2", dates)
                }
                minDate={new Date()}
                dateFormat="dd/MM/yyyy"
