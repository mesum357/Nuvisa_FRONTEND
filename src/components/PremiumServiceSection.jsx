        ...
        <div className="flex flex-col w-full lg:flex-row justify-between items-center lg:items-center mb-10 md:mb-16 gap-6">
          ...
          <div className="flex items-center justify-center">
            <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6">
              <Image src="/image/gdpr.webp" alt="GDPR" width={175} height={175} className="w-[120px] md:w-[130px] lg:w-[175px] object-contain" priority />
              <Image src="/image/ICO-new.png" alt="ICO" width={175} height={175} className="w-[120px] md:w-[130px] lg:w-[175px] object-contain" priority />
              <Image src="/image/pci-dss.png" alt="PCI" width={175} height={175} className="w-[120px] md:w-[130px] lg:w-[175px] object-contain" priority />
            </div>
          </div>
        </div>
            ...
            <div className="rounded-[30px] md:rounded-[60px] w-full flex flex-col md:flex-row items-center justify-between p-6 md:py-3 md:px-16 gap-6 md:gap-0 transition-all duration-300 lg:min-h-117.5" style={{ backgroundColor: "#daee69" }}>
              ...
              <div className="w-full md:w-1/2 flex justify-center md:justify-end">
                <div className="relative w-[220px] h-[220px] sm:w-[280px] sm:h-[280px] md:w-[450px] md:h-[450px] bg-[#ffffff]/75" style={{ clipPath: "url(#shape7)", WebkitClipPath: "url(#shape7)" }}>
                  <Image src="/image/hero-1104.webp" alt="Icon" fill className="object-contain p-6 md:p-10 pointer-events-none" priority />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-[30px] md:rounded-[60px] w-full flex flex-col md:flex-row items-center justify-between p-6 md:py-3 md:px-16 gap-6 md:gap-0 transition-all duration-300 lg:min-h-117.5" style={{ backgroundColor: "#ff8e59" }}>
              ...
              <div className="w-full md:w-1/2 flex justify-center md:justify-end">
                <div className="relative w-[220px] h-[220px] sm:w-[280px] sm:h-[280px] md:w-[450px] md:h-[450px] bg-[#fafafc]/50" style={{ clipPath: "url(#shape6)", WebkitClipPath: "url(#shape6)" }}>
                  <Image src="/image/grid-showcase-3.webp" alt="Icon" fill className="object-contain p-8 md:p-15 pointer-events-none" priority />
                </div>
              </div>
            </div>
          </div>
