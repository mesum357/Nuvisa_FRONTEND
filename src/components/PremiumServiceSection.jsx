    ...
    <div className="bg-gray-900 text-white py-20 pb-10 px-6">
      <div className="max-w-[85rem] mx-auto flex items-center flex-col justify-center">
        ...
        >
          ...
          <div className="min-w-[370px] md:min-w-[545px] flex-shrink-0" style={{ scrollSnapAlign: "start" }}>
            <div className="rounded-3xl h-[350px] w-full mb-6 relative overflow-hidden transform transition-all duration-300 hover:shadow-2xl bg-[linear-gradient(to_bottom,#FCB398_26%,#FB7F94_90%)]">
              ...
              <Image src="/image/grid-showcase-1.png" alt="Icon" width={500} height={500} className="w-full h-full object-contain pointer-events-none" priority />
            </div>
            <div>
              <h3 className="text-[32px] md:text-[45px] font-gilroy-bold mb-1 md:mb-3">Always in touch</h3>
              <p className="text-white text-[16px] font-gilroy-bold opacity-80">Got any question? Get in touch with 24/7 live human support available.</p>
            </div>
          </div>
          ...
          <div className="min-w-[370px] md:min-w-[545px] flex-shrink-0" style={{ scrollSnapAlign: "start" }}>
            <div className="rounded-3xl h-[350px] w-full mb-6 relative overflow-hidden transform transition-all duration-300 hover:shadow-2xl bg-[linear-gradient(to_top_right,#A9F423,#3ACDFB,#62DCAA)]">
              <div className="absolute inset-0 bg-gradient-to-br from-pink-500/20 to-transparent"></div>
              <Image src="/image/grid-showcase-2.png" alt="Icon" width={500} height={500} className="w-full h-full object-contain pointer-events-none" priority />
            </div>
            <div>
              <h3 className="text-[32px] md:text-[45px] font-gilroy-bold mb-1 md:mb-3">Realtime reporting</h3>
              <p className="text-white text-[16px] font-gilroy-bold opacity-80">On the go online updates for your visa process with instant handy notifications.</p>
            </div>
          </div>
          ...
          <div className="min-w-[370px] md:min-w-[545px] flex-shrink-0" style={{ scrollSnapAlign: "start" }}>
            <div className="rounded-3xl h-[350px] w-full mb-6 relative overflow-hidden transform transition-all duration-300 hover:shadow-2xl bg-[linear-gradient(to_top,#F2BBA0,#E8A4BD,#DD8CDC)]">
              <div className="absolute inset-0 bg-gradient-to-br from-pink-500/20 to-transparent"></div>
              <Image src="/image/grid-showcase-3.webp" alt="Icon" width={500} height={500} className="w-full h-full object-contain pointer-events-none" priority />
            </div>
            <div>
              <h3 className="text-[32px] md:text-[45px] font-gilroy-bold mb-1 md:mb-3">Peace of mind</h3>
              <div className="text-white text-[16px] font-gilroy-bold opacity-80">
