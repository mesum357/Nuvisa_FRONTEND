...
import { preferWebpAsset } from "@/utils/staticImages";

const reviews = [
    {
        name: "Karan T.",
        role: "Edinburgh",
        img: preferWebpAsset("/img/karan.png"),
        comment:
    ...
    },
    {
        name: "Amit D.",
        role: "Leicester",
        img: preferWebpAsset("/img/amit.png"),
        comment:
    ...
    },
    {
        name: "Imran N.",
        role: "Manchester",
        img: preferWebpAsset("/img/imran.png"),
        comment:
    ...
    },
    {
        name: "Ananya R.",
        role: "London",
        img: preferWebpAsset("/img/ananya.png"),
        comment:
    ...
    },
    {
        name: "Ayesha K.",
        role: "Birmingham",
        img: preferWebpAsset("/img/ayesha.png"),
        comment:
