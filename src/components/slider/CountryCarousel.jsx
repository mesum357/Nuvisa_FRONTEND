  ...
  return (
    <section className="mt-1 w-full max-sm:mt-0">
        ...
        <div className="overflow-hidden rounded-3xl shadow-lg max-sm:rounded-2xl">
          <div className="relative h-full w-full">
            <Image
              ...
              height={800}
              sizes={HERO_SIZES}
              className="w-full aspect-[4/3] sm:aspect-[5/4] lg:aspect-[16/10] xl:aspect-[4/3] max-h-[min(70vh,560px)] object-cover"
      ...
      <div
        ...
        className="flex justify-start pb-6 md:pb-10 gap-2 mt-6 md:mt-8 overflow-x-auto overflow-y-hidden w-full max-sm:mt-4 px-1 sm:px-4"
        style={{
          scrollbarWidth: "none",
